...
<body class="bg-default bg-light"> 
    ...
    <div class="container">        
        ...
        <div class="block-error">
            ...
            <div class="row">
                <div class="col-md-6">
                    <button class="btn btn-default btn-clean btn-block" onClick="document.location.href = '<?php echo e(url('/')); ?>';">Back to dashboard</button>
                </div>
                <div class="col-md-6">
...
</html><?php /**PATH /Users/mac/repos/ace-admin-2/resources/views/errors/404.blade.php ENDPATH**/ ?>