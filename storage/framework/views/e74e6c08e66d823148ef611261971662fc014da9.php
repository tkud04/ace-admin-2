   ...
   <?php
               ...
               <div class="block block-drop-shadow">                    
                    <div class="head bg-dot20">
                        ...
                        <div class="head-panel nm tac" style="line-height: 0px;">
                            <div class="knob">
                                <input type="text" data-fgColor="#3F97FE" data-min="0" data-max="100000000" data-width="100" data-height="100" value="<?php echo e($stats['o_total']); ?>" data-readOnly="true" style="font: bold 20px Arial !important;"/>
                            </div>                              
                        </div>
                        <div class="head-panel nm">
				...
				<div class="block block-drop-shadow">                    
                   <div class="head bg-dot20">
                      ...
                      <div class="head-panel nm">
                          ...
                          <a href="<?php echo e(url('buup')); ?>" class="btn btn-default btn-block btn-clean" style="margin-top: 5px;">Upload products</a>						  
                        </div>    
			...
			<div class="col-md-5">
               ...
               <div class="block block-drop-shadow">                    
                        ...
                        <div class="head-panel nm tac" style="line-height: 0px;">
                            <div class="knob">
                                <input type="text" data-fgColor="#3F97FE" data-min="0" data-max="100000000" data-width="100" data-height="100" value="<?php echo e($stats['total']); ?>" data-readOnly="true" style="font: bold 20px Arial !important;"/>
                            </div>                              
                        </div>
                        <div class="head-panel nm">
                            <div class="hp-info hp-simple pull-left">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/repos/ace-admin-2/resources/views/index.blade.php ENDPATH**/ ?>